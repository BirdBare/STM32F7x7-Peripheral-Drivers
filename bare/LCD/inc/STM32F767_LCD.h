...
static void DMA_WaitTransfer(DMA_Stream_TypeDef *DMAx_Streamx)
{
...
static uint8_t LCD_UpdateScreen(void)
{
...
static void LCD_DrawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
  uint16_t color)
{
...
static void LCD_DrawRect(uint16_t x, uint16_t y, uint16_t w, uint16_t h,
  uint16_t color)
{
...
static void LCD_FillCircle(uint16_t x, uint16_t y, uint16_t r, uint16_t color)
{
  int16_t a, b, P;
...
static void LCD_DrawCircle(int16_t x, int16_t y, int16_t r, uint16_t color)
{
  int16_t a, b, P;
...
static void LCD_DrawEllipse(int16_t x, int16_t y, int16_t a, int16_t b,
  uint16_t color) 
{
...
static void LCD_FillEllipse(int16_t x, int16_t y, int16_t a, int16_t b, 
  uint16_t color) 
{
  int32_t  dx = 0, dy = b; /* im I. Quadranten von links oben nach rechts unten
*/
...
static void LCD_DrawRoundRect(int16_t x, int16_t y, int16_t w,
...
static void LCD_FillRoundRect(int16_t x, int16_t y, int16_t w, int16_t h,
int16_t r, 
  uint16_t color) 
{
  // smarter version
...
static void LCD_DrawTriangle(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, 
...
static void LCD_DrawXBitmap(uint16_t x, uint16_t y,
...
static uint32_t LCD_DrawChar4(uint16_t x, uint16_t y, uint16_t c, uint16_t color,
uint8_t size)
{
  if(c == ' ')
    return size << 2;
...
static uint32_t LCD_DrawChar3(uint16_t x, uint16_t y, uint16_t c, uint16_t color,
uint8_t size)
{
  if(c == ' ')
    return size << 2;
...
/*
static uint32_t Getlength(uint16_t c)
{
if(c == ' ')
    return  4;
...
static uint32_t Length(uint16_t c)
{
