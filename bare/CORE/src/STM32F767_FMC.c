...
struct NOR_PSRAMxo
	NOR_PSRAM1o = {&RCC->AHB3ENR,0,0,0,NOR_PSRAM1},
	NOR_PSRAM2o = {&RCC->AHB3ENR,0,0,0,NOR_PSRAM2},
	NOR_PSRAM3o = {&RCC->AHB3ENR,0,0,0,NOR_PSRAM3},
	NOR_PSRAM4o = {&RCC->AHB3ENR,0,0,0,NOR_PSRAM4};
