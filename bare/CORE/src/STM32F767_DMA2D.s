...
pop {r4, pc}
  ...
  .type DMA2D_Mem2MemPFC, %function
  .global DMA2D_Mem2MemPFC
DMA2D_Mem2MemPFC:
  ...
  str r1, [r0, #0xc]
  str lr, [r0, #0x44]
  ldr lr, [sp, #12] //load 6th parameter from stack OOR
  str r2, [r0, #0x3c]
  str lr, [r0, #0x10]
  ldr lr, [sp, #16] //load 7th parameter from stack OOR
  str r3, [r0, #0x1c]
  str lr, [r0, #0x40]
  str r4, [r0, #0x34]
  //set DMA2D registers
