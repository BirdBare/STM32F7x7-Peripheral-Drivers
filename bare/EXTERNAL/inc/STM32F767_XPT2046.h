...
#ifndef STM32F407_XPT2046_h
#define STM32F407_XPT2046_h
...
#define XPT2046_MISO GPIO_PIN_6
#define XPT2046_CLK GPIO_PIN_5

extern void XPT2046_EnableGeneral(void);
/*{
  GPIO_EnableClock(GPIO_CLOCK_GPIOA);
  GPIO_EnableClock(GPIO_CLOCK_GPIOC);
  SPI_EnableClockAPB2(SPI_CLOCK_SPI1);

  GPIO_SetPins(GPIOC, XPT2046_CS,GPIO_MODE_OUTPUT,
  ...
  GPIO_SetPins(GPIOA,XPT2046_CLK | XPT2046_MISO | XPT2046_MOSI,
...
#define XPT2046_StartBit 0b10000000
#define XPT2046_AXIS_X 0b01010000
#define XPT2046_AXIS_Y 0b00010000
#define XPT2046_AXIS_Z1 0b00110000
#define XPT2046_AXIS_Z2 0b01000000
...
extern void XPT2046_Begin(void);
/*{
  GPIO_ToggleOutput(GPIOC,XPT2046_CS);
  PERIPH_LoopTillFlagSet(&SPI1->SR,SPI_SR_TXE);
